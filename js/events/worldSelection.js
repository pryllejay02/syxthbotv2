...
function buildBaseStats(selectedClass) {
  return {
    attack: Number(selectedClass.baseStats.attack || 10),
    defense: Number(selectedClass.baseStats.defense || 5),
    maxHp: Number(selectedClass.baseStats.maxHp || 100),
    dodge: Number(selectedClass.baseStats.dodge || 0),
    crit: Number(selectedClass.baseStats.crit || 0),
  };
}
